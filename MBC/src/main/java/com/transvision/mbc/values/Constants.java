...
public class Constants {
    ...
    public static final int SUBDIV_DETAILS_SUCCESS = 4;
    public static final int SUBDIV_DETAILS_FAILURE = 5;
    public static final int BILLING_FILE_SUMMARY_SUCCESS = 6;
    public static final int BILLING_FILE_SUMMARY_FAILURE = 7;
    public static final int MRTRACKING_SUCCESS = 8;
    public static final int MRTRACKING_FAILURE = 9;
    public static final int DLG_APK_UPDATE_SUCCESS = 10;
    public static final int DLG_APK_UPDATE_FAILURE = 11;
